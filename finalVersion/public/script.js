...
let maxY = 0;
  ...
  for(let i = 0; i < detections.length; i++){
    console.log("nooooooowwwwwwww mouth");
      ...
      document.getElementById("recieve3").src = imgData;
...
function drawNoseLandmarks(detections){
  ...
  for(let i = 0; i < detections.length; i++){
    console.log("nooooooowwwwwwww nose");
      ...
      document.getElementById("recieve5").src = imgData;
...
function drawLefteyeLandmarks(detections){
  ...
  for(let i = 0; i < detections.length; i++){
    console.log("nooooooowwwwwwww leftEye");
      ...
      document.getElementById("recieve1").src = imgData;
...
document.getElementById("recieve2").src = imgData;
...
document.getElementById("recieve4").src = imgData;
...
let sendbutton = document.getElementById("send");
 ...
 setTimeout(() => {
  ...
  li.innerText = `🫶You have contributed face part ${time}`;
  ul.appendChild(li);
 },5000);
...
}, 5500); /* Delay the scrolling code for 5000 milliseconds (5 seconds) */
